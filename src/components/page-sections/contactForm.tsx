...
const ContactForm = () => {
  ...
  const url =
    "https://script.google.com/macros/s/AKfycbwHt9ISXBbmqGUgzWFdgJxdLpmx2VzWj5N_yiDH6FMyFzJeFxyjX1rqBd0KMTA64Vv111RxQ/exec";
  ...
  const phoneNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsValidPhone(/^\+971-\d{5}-\d{5}$/.test(formatted));
  };
        ...
        <div className="tt-row tt-xl-row-reverse">
          ...
          <div className="tt-col-xl-5">
            ...
            <div className="tt-contact-info margin-bottom-80">
              {/* Begin big arrow */}
              <div className="tt-big-arrow tt-ba-angle-bottom-right tt-anim-fadeinup">
                ...
                <div className="tt-contact-details margin-bottom-50 tt-anim-fadeinup">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <a href="tel+971507528009" className="tt-link">
                        +971507528009
                      </a>
                    </li>
                    <li>
